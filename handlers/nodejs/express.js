...
export async function handleExpress(templateConfig, bearerToken) {
    ...
    return new Promise((resolve, reject) => {
      https.get(url, (res) => {
        ...
        res.on('end', () => {
          ...
          // Se for o arquivo do servidor, substituir a chave da API
  ...
  return Promise.all(downloadPromises).then((paths) => {
    ...
    console.log(chalk.blue('3. node server.js'));
  });
}
